...
import { Car, MapPin, Clock, CheckCircle, XCircle, Loader2, Trash2 } from "lucide-react";
                ...
                myRequests.map((req) => (
                  <div key={req.id} className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                    <div className={`px-4 py-2 text-[10px] font-black uppercase flex items-center justify-between ${
                      ...
                      <button onClick={() => handleCancelRide(req.id, req.status)} className="text-gray-400 hover:text-red-500">
