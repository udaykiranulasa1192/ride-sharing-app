      ...
      <main className="max-w-md mx-auto p-4 space-y-6">
        ...
        <div className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
          ...
          <div className="p-4 flex items-center gap-4">
            ...
            <div>
              <p className="text-[10px] font-bold text-gray-400 uppercase tracking-wide">Default Postcode</p>
              <p className="text-sm font-semibold text-gray-900 uppercase">{profile?.postcode}</p>
            </div>
          </div>
        </div>
        ...
        <button 
          ...
          className="w-full flex items-center justify-center gap-2 bg-red-50 text-red-600 font-bold py-4 rounded-2xl hover:bg-red-100 transition-all active:scale-95 mt-8"
        >
