...
export default function PassengerBottomNav() {
  ...
  const isBookings = pathname.includes("/dashboard");
      ...
      <div className="mx-auto flex max-w-md justify-between items-center">
        ...
        <Link 
          ...
          className={`flex flex-col items-center gap-1 p-2 transition-colors ${
            isSearch ? "text-emerald-600" : "text-gray-400 hover:text-gray-600"
          }`}
        >
        ...
        <Link 
          ...
          className={`flex flex-col items-center gap-1 p-2 transition-colors ${
            isBookings ? "text-emerald-600" : "text-gray-400 hover:text-gray-600"
          }`}
        >
        ...
        <Link 
          ...
          className={`flex flex-col items-center gap-1 p-2 transition-colors ${
            isProfile ? "text-emerald-600" : "text-gray-400 hover:text-gray-600"
          }`}
        >
